...
struct ContentView: View {
    ...
    var body: some View {
        VStack(alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/) {
            ...
            VStack(spacing: 20.0) {
                Slider(value: $redLevel, in: 0...1, minimumValueLabel: Text("R"), maximumValueLabel: Text("")) {}
                Slider(value: $greenLevel, in: 0...1, minimumValueLabel: Text("G"), maximumValueLabel: Text("")) {}
